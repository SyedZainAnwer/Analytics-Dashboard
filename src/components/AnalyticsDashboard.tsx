...
const Badge = ({ percentage }: { percentage: number }) => {
    ...
    return (
        ...
        `}>
            ...
            {isNegative ? <ArrowUpRight className="h-3 w-3"/> : null}
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <Card className="flex flex-col sm:grid grid-cols-4 gap-6">
                <h2 className="w-full text-dark-tremor-content-strong text-center sm:left-left font-semibold text-xl">This Week's top visitors</h2>
                <div className="col-span-3 flex items-center justify-between flex-wrap gap-8">
                    {topCountries?.map(([countryCode, number]) => {
                        return <div className="flex items-center gap-3 text-dark-tremor-strong">
